...
class Consulta
{
    ...
    private function buscar(Builder $consulta, array $campos, string $valorBuscado)
    {
    ...
    {
        if (is_string($modelo)) {
            $nombreModelo = "\\App\\Models\\{$modelo}";
    ...
    public function ejecutarConsultaPaginada(array $parametros): array
    {
        $resultado = $this->ejecutarconsulta($parametros);
